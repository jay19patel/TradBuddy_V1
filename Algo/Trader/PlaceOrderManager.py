...
async def PlaceOrder(account, strategy_name, trad_index, trad_side,trad_price,Fyers,TradBuddy):
    ...
    quantity, current_option_sl ,current_option_tg = TradBuddy.Get_quantity(trade_amount=todays_trad_margin,
    ...
    logging.info(f" Order Placed : {option_symbol}| QTY:[{quantity}]-{account_id}-{strategy_name}- {order_place_status}")
